[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;decor;wobbly;cube;place;move;rotate;resize;regex;addhelper;showdesktop;switcher;animation;
...
s0_outputs = 1366x768+0+0;1920x1080+1366+0;
...
s0_minimize_window_key = <Super>End
s0_minimize_window_button = Disabled
s0_maximize_window_key = <Super>Prior
s0_unmaximize_window_key = <Super>Next
...
s0_open_matches = (type=Normal | Dialog | ModalDialog | Unknown) & !(name=gnome-screensaver);(type=Menu | PopupMenu | DropdownMenu | Combo);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_open_options = ;;;
s0_open_random_effects = 
s0_close_effects = animation:Zoom;animation:Fade;animation:Fade;
s0_close_durations = 200;150;150;
s0_close_matches = (type=Normal | Dialog | ModalDialog | Unknown) & !(name=gnome-screensaver);(type=Menu | PopupMenu | DropdownMenu | Combo);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_close_options = ;;;
...
s0_inactive_shadow_radius = 8.000000
s0_inactive_shadow_opacity = 0.500000
